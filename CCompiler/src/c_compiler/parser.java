...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Mar 18 23:44:10 CST 2020
  */
	...
	public void report_error(String errorBody, Object info) {
		StringBuffer errorHead = new StringBuffer("Error");
			if(info instanceof java_cup.runtime.Symbol){
				...
				if (s.left >= 0) {
					errorHead.append(" Line: "+(s.right+1));
					if (s.right >= 0){
						errorHead.append(", Column: "+(s.left+1));
				}
			}
			if(s.value != null){
				errorHead.append(" with the Token: "+s.value);
			}
			errorHead.append(": ");
		}
